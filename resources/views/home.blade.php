            ...
            <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            @foreach ($breakfastFoods as $breakfastFood)
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded"
                                            src="{{ asset('assets/img/' . $breakfastFood->image . '') }}" alt=""
                                            style="width: 80px;">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>{{ $breakfastFood->name }}</span>
                                                <span class="text-primary">${{ $breakfastFood->price }}</span>
                                            </h5>
                                            <small
                                                class="fst-italic">{{ substr($breakfastFood->description, 0, 70) }}</small>
                                            <a type="button" href="{{ route('food.details', $breakfastFood->id) }}"
                        ...
                        <div class="row g-4">
                            @foreach ($lunchFoods as $lunchFood)
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded"
                                            src="{{ asset('assets/img/' . $lunchFood->image . '') }}" alt=""
                                            style="width: 80px;">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                            ...
                                            <a type="button" href="{{ route('food.details', $lunchFood->id) }}"
                                                class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                        </div>
                                    </div>
                                </div>
